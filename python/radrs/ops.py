...
if _ops is None:
    ...
    class AzimuthPlan:  # pragma: no cover - fallback stub
        def __init__(self, *args, **kwargs):
            raise NotImplementedError("radrs.ops module not available")

    class RangePlan:  # pragma: no cover - fallback stub
        def __init__(self, *args, **kwargs):
            raise NotImplementedError("radrs.ops module not available")

    def align_azimuth(src_azimuth, dst_azimuth, tolerance_deg=None, wrap=True):
        raise NotImplementedError("radrs.ops module not available")
    ...
    def velocity_texture(vradh, nyquist=None, wind_size=None):
        raise NotImplementedError("radrs.ops module not available")
